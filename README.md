# PSOC&trade; Control C1 MCU: CCU4 PWM
...
[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce242913-ccu4-pwm)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[CCU4 pwm](https://github.com/Infineon/mtb-example-ce242913-ccu4-pwm)" application with the desired name "CCU4 pwm" configured for the *KIT_PSC1M3_EVK* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSC1M3_EVK --app-id mtb-example-ce242913-ccu4-pwm --user-app-name CCU4 pwm --target-dir "C:/mtb_projects"
   ```
...
3. Confirm that the USER_LED blinks at approximately 2 Hz
...
In the main function, the interrupt will be initialized and used to restart the timer and clear the interrupt event flag (`PWM_0_PERIOD_MATCH_EVENT_IRQN`).
...
| :-------  	    	    |		 :------------  | :------------  			     |
|CCU4 (CC4_0) (PDL)	    | PWM_0 	        	| CCU4 slice used to generate the PWM signal |
...
Document title: *CE242913* – *PSOC&trade; Control C1 MCU: CCU4 PWM*
